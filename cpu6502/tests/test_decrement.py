...
class TestDEC:
    ...
    def test_dec_zero_page(self, setup_cpu, start_val, end_val):
    ...
    @pytest.mark.parametrize('end_val, start_val', [(0x0, 0x1), (0x1, 0x2), (0xab, 0xac), (0xfe, 0xff), (0xff, 0x0)])
    def test_dec_zero_page_x(self, setup_cpu, start_val, end_val):
    ...
    @pytest.mark.parametrize('end_val, start_val', [(0x0, 0x1), (0x1, 0x2), (0xab, 0xac), (0xfe, 0xff), (0xff, 0x0)])
    def test_dec_absolute(self, setup_cpu, start_val, end_val):
    ...
    @pytest.mark.parametrize('end_val, start_val', [(0x0, 0x1), (0x1, 0x2), (0xab, 0xac), (0xfe, 0xff), (0xff, 0x0)])
    def test_dec_absolute_x(self, setup_cpu, start_val, end_val):
...
class TestDEX:
    ...
    @pytest.mark.parametrize('end_val, start_val', [(0x0, 0x1), (0x1, 0x2), (0xab, 0xac), (0xfe, 0xff), (0xff, 0x0)])
    def test_dex_implied(self, setup_cpu, start_val, end_val):
...
class TestDEY:
    ...
    @pytest.mark.parametrize('end_val, start_val', [(0x0, 0x1), (0x1, 0x2), (0xab, 0xac), (0xfe, 0xff), (0xff, 0x0)])
    def test_dey_implied(self, setup_cpu, start_val, end_val):
